        ...
        <div class="googs">
            ...
            <div class="menu-wrapper" ref="menuWrapper">
                <scroll-view scroll-y class="left-con" :style="'height:'+contentLeftHeight" >
                    <ul>
                        <li class="telmp" v-for="(item,index) in category" :key="item" :class="{'checkActive':index == selectIndex}">
            ...
            <div class="foods-wrapper" ref="foodsWrapper">
                ...
                <scroll-view scroll-y class="cell-list-border" @scrolltolower="lower" :style="'height:'+contentRightHeight">
                    <div class="cell-list" v-for="item in list" :key="item">
                        <div class="cell-left">
